...
function setup() {
	...
	helicopterSprite=createSprite(700, 100, 10,10);
	helicopterSprite.addImage(helicopterIMG)
	helicopterSprite.scale=0.6

	box1 = createSprite(850, 610, 20,100);
	box1.shapeColor=color("red")

	box2 = createSprite(450,610, 20,100);
	box2.shapeColor=color("red")

	box3 = createSprite(650,650, 400,20);
	...
	packageBody = Bodies.circle(700 , 100 , 5, {restitution:0.6});
